...
parser.add_argument('--resume', default='./cub200/checkpoint_alexnet.pth.tar', type=str, metavar='PATH',
...
def main():
    ...
    np.save('./cub200/all_gt_target_alexnet_te.npy', all_gt_target_te)
